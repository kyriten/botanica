...
@section('post')
    <main class="main" id="main">
        ...
        <div class="pagetitle">
            <h1>Tambah Kelurahan/Desa Baru</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('city.index') }}">Kelurahan/Desa</a></li>
                    <li class="breadcrumb-item active">Kelurahan/Desa Baru</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            ...
            @endif
            <form id="addMarkerForm" action="{{ route('village.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <label for="cityID" class="col-sm-2 col-form-label text-dark align-items-center"
                                        style="font-size: 14px">Nama Kota/Kabupaten</label>
                                    <div class="col-sm-10 mb-3" data-mdb-input-init>
                                        <input class="form-control" id="cityID" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 mb-3">
                                        <select name="district_id" id="districtID"
                                            class="form-select select2 @error('district_id') is-invalid @enderror" data-placeholder="-- Pilih Kecamatan --" required>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-dark align-items-center"
                                        style="font-size: 14px">Nama Kelurahan <span class="text-danger"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Wajib diisi">*</span></label>
                                    <div class="col-sm-10 mb-3">
                                        ...
                                        <span class="form-text">Gunakan alfabet dan titik. Tambahkan kata
                                            "Kelurahan" sebelum nama. <br> <strong>Contoh:</strong> <strong>Kota</strong>
